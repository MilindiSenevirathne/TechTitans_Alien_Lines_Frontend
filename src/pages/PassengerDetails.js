...
export default function PassegerDetails({ navigation }) {
  ...
  const nav = useNavigation();
    ...
    const handleChooseServices = () => {
        nav.navigate('ChooseServices', { rate: rate, selectedSpaceship: selectedSpaceship });
    };
      ...
      <ScrollView>
        ...
        <Card style={styles.card}>
          <View style={styles.miniContainer}>
            ...
            <View style={styles.textfield}>
              <DropdownField list={nationalityOptions} label="Nationality" />
            </View>
          ...
          <View style={styles.miniContainer}>
            <View style={styles.textContainer}>
              ...
              <Text style={{ fontSize: 14, fontWeight: "400" }}>
                We will send a ticket to this email.
              </Text>
              <Text style={{ fontSize: 14, fontWeight: "400" }}>
                Phone number is required for communication in case of changes
              </Text>
            </View>
        ...
        <View style={styles.bottomContainer}>
          <View style={styles.leftButtonContainer}>
            ...
            >
              <View>
                <Text
                  style={{ fontSize: 10, fontWeight: "500", marginBottom: 10 }}
                >
                  Total
                </Text>
                <Text
          ...
          <View style={styles.rightButtonContainer}>
            <TouchableOpacity
              ...
              onPress={this._onPressButton}
            >
              <Button onPress={handleChooseServices}>
